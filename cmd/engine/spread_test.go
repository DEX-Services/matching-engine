...
func TestValidateComboLegSpecs_AcceptsValidVertical(t *testing.T) {
	...
	insts := []*optionInstrument{
		sampleInstrument("BTC-BI2XUSD-60000-20260101-CALL", "BTC-BI2XUSD", "CALL", "60000", expiry),
		sampleInstrument("BTC-BI2XUSD-65000-20260101-CALL", "BTC-BI2XUSD", "CALL", "65000", expiry),
	}
	underlying, err := validateComboLegSpecs(insts)
	if err != nil {
		t.Fatalf("expected a valid vertical, got error: %v", err)
	}
	if underlying != "BTC-BI2XUSD" {
		t.Fatalf("underlying = %s, want BTC-BI2XUSD", underlying)
	}
}
...
func TestValidateComboLegSpecs_AcceptsIronCondor(t *testing.T) {
	expiry := time.Now().Add(24 * time.Hour)
	insts := []*optionInstrument{
		sampleInstrument("BTC-BI2XUSD-50000-20260101-PUT", "BTC-BI2XUSD", "PUT", "50000", expiry),
		sampleInstrument("BTC-BI2XUSD-55000-20260101-PUT", "BTC-BI2XUSD", "PUT", "55000", expiry),
		sampleInstrument("BTC-BI2XUSD-65000-20260101-CALL", "BTC-BI2XUSD", "CALL", "65000", expiry),
		sampleInstrument("BTC-BI2XUSD-70000-20260101-CALL", "BTC-BI2XUSD", "CALL", "70000", expiry),
	}
...
func TestValidateComboLegSpecs_RejectsDifferentUnderlying(t *testing.T) {
	...
	insts := []*optionInstrument{
		sampleInstrument("BTC-BI2XUSD-60000-20260101-CALL", "BTC-BI2XUSD", "CALL", "60000", expiry),
		sampleInstrument("ETH-BI2XUSD-65000-20260101-CALL", "ETH-BI2XUSD", "CALL", "65000", expiry),
	}
	if _, err := validateComboLegSpecs(insts); err == nil {
...
func TestValidateComboLegSpecs_RejectsDifferentExpiry(t *testing.T) {
	insts := []*optionInstrument{
		sampleInstrument("BTC-BI2XUSD-60000-20260101-CALL", "BTC-BI2XUSD", "CALL", "60000", time.Now().Add(24*time.Hour)),
		sampleInstrument("BTC-BI2XUSD-65000-20260201-CALL", "BTC-BI2XUSD", "CALL", "65000", time.Now().Add(48*time.Hour)),
	}
	if _, err := validateComboLegSpecs(insts); err == nil {
...
func TestComboSymbolFor_DeterministicAndOrderInsensitive(t *testing.T) {
	legs := []models.ComboLeg{
		{Symbol: "BTC-BI2XUSD-60000-20260101-CALL", Ratio: 1},
...
func TestComboSymbolFor_DistinguishesLegCount(t *testing.T) {
	...
	butterfly := comboSymbolFor([]models.ComboLeg{
		{Symbol: "BTC-BI2XUSD-55000-20260101-CALL", Ratio: 1},
		{Symbol: "BTC-BI2XUSD-60000-20260101-CALL", Ratio: -2},
		{Symbol: "BTC-BI2XUSD-65000-20260101-CALL", Ratio: 1},
	})
...
func TestGetOrCreateComboInstrument_MemoryFallbackRoundTrips(t *testing.T) {
	...
	created, err := getOrCreateComboInstrument(ctx, nil, legs, "BTC-BI2XUSD")
	if err != nil {
	...
	if len(loaded.Legs) != 2 || loaded.Underlying != "BTC-BI2XUSD" {
		t.Fatalf("loaded combo instrument = %+v, want 2 legs, underlying BTC-BI2XUSD", loaded)
	}
}
...
func TestGetOrCreateComboInstrument_MemoryFallbackRoundTripsNLegs(t *testing.T) {
	ctx := context.Background()
	legs := []models.ComboLeg{
		{Symbol: "BTC-BI2XUSD-50000-20260101-PUT", Ratio: 1},
		{Symbol: "BTC-BI2XUSD-55000-20260101-PUT", Ratio: -1},
		{Symbol: "BTC-BI2XUSD-65000-20260101-CALL", Ratio: -1},
		{Symbol: "BTC-BI2XUSD-70000-20260101-CALL", Ratio: 1},
	}
	created, err := getOrCreateComboInstrument(ctx, nil, legs, "BTC-BI2XUSD")
	if err != nil {
