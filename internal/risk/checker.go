...
// underlying (e.g. "BTC-BIUSDB"), so the options margin model can price a
...
// "BTC-BIUSDB") from an option instrument symbol, mirroring
...
// Symbol format: "BASE-QUOTE" (e.g. "BTC-BIUSDB").
