...
func TestVerticalSpreadMargin_NetDebitNeedsNoAdditionalMargin(t *testing.T) {
	...
	got := VerticalSpreadMargin(fixedpoint.FromInt64(60000), fixedpoint.FromInt64(65000), fixedpoint.FromInt64(1), fixedpoint.FromInt64(-1000))
	if !got.IsZero() {
...
func TestVerticalSpreadMargin_ExactZeroPremiumNeedsFullMargin(t *testing.T) {
	...
	got := VerticalSpreadMargin(fixedpoint.FromInt64(60000), fixedpoint.FromInt64(65000), fixedpoint.FromInt64(1), fixedpoint.Zero)
	want := fixedpoint.FromInt64(5000)
	if !got.Equal(want) {
...
func TestVerticalSpreadMargin_NetCreditNeedsStrikeDistanceMinusCredit(t *testing.T) {
	...
	got := VerticalSpreadMargin(fixedpoint.FromInt64(60000), fixedpoint.FromInt64(65000), fixedpoint.FromInt64(1), fixedpoint.FromInt64(500))
	want := fixedpoint.FromInt64(4500)
	if !got.Equal(want) {
...
func TestVerticalSpreadMargin_CreditExceedingStrikeDistanceFloorsAtZero(t *testing.T) {
	...
	got := VerticalSpreadMargin(fixedpoint.FromInt64(60000), fixedpoint.FromInt64(65000), fixedpoint.FromInt64(1), fixedpoint.FromInt64(6000))
	if !got.IsZero() {
...
func TestVerticalSpreadMargin_ScalesWithQty(t *testing.T) {
	got := VerticalSpreadMargin(fixedpoint.FromInt64(60000), fixedpoint.FromInt64(65000), fixedpoint.FromInt64(3), fixedpoint.FromInt64(500))
	// Strike distance per contract 5000 * 3 = 15000, minus the (already
	// qty-scaled) 500 credit passed in -> 14500.
	want := fixedpoint.FromInt64(14500)
	if !got.Equal(want) {
...
func TestVerticalSpreadMargin_NeverExceedsStrikeDistance(t *testing.T) {
	...
	strikeDistance := fixedpoint.FromInt64(5000)
	got := VerticalSpreadMargin(fixedpoint.FromInt64(60000), fixedpoint.FromInt64(65000), fixedpoint.FromInt64(1), fixedpoint.FromInt64(1))
...
func TestVerticalSpreadMargin_ZeroQtyIsZero(t *testing.T) {
	got := VerticalSpreadMargin(fixedpoint.FromInt64(60000), fixedpoint.FromInt64(65000), fixedpoint.Zero, fixedpoint.FromInt64(500))
	if !got.IsZero() {
...
func TestVerticalSpreadMargin_StrikeOrderDoesNotMatter(t *testing.T) {
	...
	a := VerticalSpreadMargin(fixedpoint.FromInt64(60000), fixedpoint.FromInt64(65000), fixedpoint.FromInt64(1), fixedpoint.FromInt64(500))
	b := VerticalSpreadMargin(fixedpoint.FromInt64(65000), fixedpoint.FromInt64(60000), fixedpoint.FromInt64(1), fixedpoint.FromInt64(500))
	if !a.Equal(b) {
