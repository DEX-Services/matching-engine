...
import "github.com/dex/matching-engine/internal/fixedpoint"
...
type MarginCallInfo struct {
	...
	StrikePrice fixedpoint.Fixed `json:"strikePrice"`
	Size        fixedpoint.Fixed `json:"size"` // negative (short)
	...
	RequiredMargin fixedpoint.Fixed `json:"requiredMargin"`
	ReservedMargin fixedpoint.Fixed `json:"reservedMargin"` // the cash-secured amount originally locked (strike*|size|)
	...
	Equity         fixedpoint.Fixed `json:"equity"`
	UtilizationPct fixedpoint.Fixed `json:"utilizationPct"` // RequiredMargin / Equity * 100
}
...
type Liquidation struct {
	...
	Size      fixedpoint.Fixed `json:"size"`
	MarkPrice fixedpoint.Fixed `json:"markPrice"`
}
...
type Funding struct {
	AccountID string           `json:"accountId"`
	Symbol    string           `json:"symbol"`
	Rate      fixedpoint.Fixed `json:"rate"`
	Payment   fixedpoint.Fixed `json:"payment"`
}
...
type RealizedPnl struct {
	AccountID      string           `json:"accountId"`
	Symbol         string           `json:"symbol"`
	ClosedQty      fixedpoint.Fixed `json:"closedQty"`
	Pnl            fixedpoint.Fixed `json:"pnl"`
	MarginReturned fixedpoint.Fixed `json:"marginReturned"`
